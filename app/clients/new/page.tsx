    ...
    return (
        <>
            <div className="page-header">
                <div>
                    <div className="page-header-title">Add New Client</div>
                    <div className="page-header-sub">Fill in the details to register a new client.</div>
                </div>
                <Link href="/clients" className="btn btn-ghost">← Back to Clients</Link>
            </div>
            ...
            <div style={{ maxWidth: 720 }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginBottom: 28 }}>
                    {[1, 2].map(s => (
                        <div key={s} style={{
                            display: 'flex', alignItems: 'center', gap: 8, cursor: s === 2 ? 'pointer' : 'default'
                ...
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="card">
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group">
                                    ...
                                    <select id="client-status" className="form-select" value={form.status} onChange={e => setField('status', e.target.value)}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea id="client-notes" className="form-textarea" value={form.notes} onChange={e => setField('notes', e.target.value)} placeholder="Additional notes about this client…" />
                            </div>
                            ...
                            <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end', marginTop: 8 }}>
                                ...
                                <button type="submit" className="btn btn-primary" disabled={saving || !form.company_name} id="save-client-btn">
                    ...
                    {step === 2 && (
                        <div className="card">
                            ...
                            <div className="card-subtitle" style={{ marginBottom: 20 }}>Optional — you can skip this and add interactions later from the client detail page.</div>
                                ...
                                <>
                                    <div className="form-row">
                                        <div className="form-group">
                                            ...
                                            <input id="ix-date" className="form-input" type="date" value={ix.date} onChange={e => setIxField('date', e.target.value)} />
                                        </div>
                                        <div className="form-group">
                                            <label className="form-label">Attendee</label>
                                            <input id="ix-attendee" className="form-input" value={ix.attendee} onChange={e => setIxField('attendee', e.target.value)} placeholder="Name(s) of attendees" />
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label className="form-label">Sales Topic</label>
                                        <textarea id="ix-sales" className="form-textarea" value={ix.sales_topic} onChange={e => setIxField('sales_topic', e.target.value)} placeholder="Sales discussion points, deals, proposals…" />
                                    </div>
                                    <div className="form-group">
                                        <label className="form-label">FAE Topic</label>
                                        <textarea id="ix-fae" className="form-textarea" value={ix.fae_topic} onChange={e => setIxField('fae_topic', e.target.value)} placeholder="Technical / FAE topics discussed…" />
                                    </div>
                                    <div className="form-group">
                                        <label className="form-label">Additional Notes</label>
                                        <textarea id="ix-notes" className="form-textarea" value={ix.notes} onChange={e => setIxField('notes', e.target.value)} placeholder="Any other notes…" />
                                    </div>
                                </>
                            )}
                            ...
                            <div style={{ display: 'flex', gap: 10, justifyContent: 'space-between', marginTop: 8 }}>
                                ...
                                <button type="submit" className="btn btn-primary" disabled={saving} id="save-client-final-btn">
                                    {saving ? 'Saving…' : 'Save Client'}
                                </button>
                            </div>
                        </div>
